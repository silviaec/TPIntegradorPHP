...
<?php
    ...
    $sql = "SELECT * FROM noticias WHERE IdEscritor = '".$_GET['id']."' ORDER BY Fecha Desc";
...
?>
	...
	<?php foreach ($resultado as $rows) { ?>
        ...
        <td><?=$rows["Tema"];?></td>
		<td><a href="noticiaEditar.php?action=editar&id=<?=$rows["IdNoticia"];?>" class="glyphicon glyphicon-pencil"></a></td>
	...
	<h4><a href="escritorNuevo.php">Agregar Escritor</a></h4>
	<h4><a href="escritorEliminar.php">Eliminar Escritor</a></h4>
